	...
	fun multiply(source: BufferedImage, multiplier: BufferedImage): BufferedImage {
		...
		for (x in 0 until source.width) {
			for (y in 0 until source.height) {
				...
				val a = (sourcecol and 0x000000ff) * (mulcol and 0x000000ff)
				val b = ((sourcecol and 0x0000ff00) shr 8) * ((mulcol and 0x0000ff00) shr 8)
				val g = ((sourcecol and 0x00ff0000) shr 16) * ((mulcol and 0x00ff0000) shr 16)
				val r = ((sourcecol and 0x7f000000) shr 24) * ((mulcol and 0x7f000000) shr 24)
